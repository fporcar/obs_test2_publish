...
app.put('/api/savefile/:file', function(req, res) {
...
/*  const out =  await fetch('http://localhost:3001/api/savefile/' + fileOut , { method: 'PUT' })
    //fetch('http://localhost:3001/api/E', { method: 'PUT' })
    .then(  (response) => response.text())
...
function postRequest(robot, fileOut)
{
  ...
  .then(function (response) {
    ...
    // Cambiamos la propiedad initialPosition por FinalPosition 
    rob.FinalPosition = rob.initialPosition;
    delete rob.initialPosition;
